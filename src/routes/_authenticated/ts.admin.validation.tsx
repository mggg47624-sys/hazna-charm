...
function Page() {
  ...
  const upload = useUploadValidation();
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      <div>
        <h1 className="text-2xl font-semibold">Validation (Registration) Dump</h1>
        <p className="text-sm text-muted-foreground">
          Upload the registration Excel. Matches within 7 days of last call are credited to the agent.
        </p>
      </div>
      <Card>
        ...
        <CardContent className="space-y-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              Columns: Phone, Full Name, Company, Registration Date, Activation Date (optional).
            </p>
          </div>
